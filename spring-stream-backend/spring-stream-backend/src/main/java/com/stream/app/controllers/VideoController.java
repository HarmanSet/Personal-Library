...
public class VideoController {
    ...
    // Get videos by type (video/audio)
    @GetMapping("/type/{fileType}")
    public List<Video> getAllByType(@PathVariable String fileType){
        return videoService.getAllByType(fileType);
    }

    // Search videos by title and type
    @GetMapping("/search")
    public List<Video> searchByTitle(
            @RequestParam String title,
            @RequestParam String fileType){
        return videoService.searchByTitle(title, fileType);
    }
